...
public class LogService {
    ...
    public List<LogDTO> queryLogsInWeek(Integer userId, LocalDate startDate, LocalDate endDate) {
        ...
        List<Log> logs = logRepository.findByEmployeeEmployeeIdAndCreatedTimeBetween(userId, startDateTime, endDateTime);
        return convertToDtoList(logs);
    }
    ...
    public List<LogDTO> queryLogsInMonth(Integer userId, LocalDate startDate, LocalDate endDate) {
        ...
        LocalDateTime endDateTime = (endDate == null ? startDate.withDayOfMonth(startDate.lengthOfMonth()) : endDate).atTime(LocalTime.MAX);
