-- ===============================
-- V2_new__insert_test_data.sql
-- 新版测试数据插入脚本（在原有 V2 基础上，额外增强日志等测试数据）
-- ===============================
...
-- 5.1 额外项目测试数据：覆盖 CEO 与技术/市场/人力部门
INSERT INTO project (title, content, start_time, end_time, project_status, sender_id, team_id) VALUES
('人力资源优化项目', '由CEO发起的人力资源优化与绩效改进项目', '2025-09-01 09:00:00', '2025-12-31 18:00:00', 1, 2, 3),
('品牌升级与公关项目', '由CEO发起的品牌升级与公关活动项目', '2025-10-01 09:00:00', '2026-01-31 18:00:00', 1, 2, 2),
('技术债务清理项目', '技术部经理牵头的代码重构与技术债务清理项目', '2025-11-01 09:00:00', '2026-02-28 18:00:00', 1, 3, 1);
...
-- 6.1 额外里程碑测试数据：对应新增项目 5,6 (自增ID 将为 10-13)
INSERT INTO milestone (title, content, project_id) VALUES
('绩效方案设计', '设计新的绩效考核与晋升方案', 5),
('试点推行', '在人力资源部试点推行新方案', 5),
('品牌定位与口号确定', '完成品牌定位梳理与口号确定', 6),
('公关活动执行', '执行线上线下公关活动', 6);
...
('数据库设计', '设计系统数据库表结构', '2025-10-10 09:00:00', '2025-10-22 18:00:00', 1, 2, 11, 7, 1, 1),
('API接口开发', '开发系统核心API接口', '2025-10-21 09:00:00', '2025-11-22 18:00:00', 0, 2, 11, 7, 1, 3),
('前端页面开发', '开发系统前端页面', '2025-11-01 09:00:00', '2025-11-22 18:00:00', 0, 1, 11, 7, 1, 3),
('市场调研', '进行市场调研分析', '2025-10-01 09:00:00', '2025-11-22 18:00:00', 2, 2, 12, 8, 1, 5),
('推广文案撰写', '撰写产品推广文案', '2025-10-16 09:00:00', '2025-11-25 18:00:00', 1, 1, 12, 8, 1, 6),
('广告投放', '执行线上广告投放', '2025-11-01 09:00:00', '2025-11-30 18:00:00', 0, 2, 12, 8, 1, 6),
('招聘需求收集', '收集各部门招聘需求', '2025-10-01 09:00:00', '2025-11-23 18:00:00', 2, 1, 13, 9, 1, NULL),
('简历筛选', '筛选候选人简历', '2025-10-11 09:00:00', '2025-11-23 18:00:00', 1, 1, 13, 9, 1, NULL),
('月度财务报表', '编制10月份财务报表', '2025-11-01 09:00:00', '2025-11-25 18:00:00', 0, 2, 14, 10, 1, NULL),
('预算审核', '审核各部门预算申请', '2025-10-15 09:00:00', '2025-11-25 18:00:00', 2, 1, 14, 10, 1, NULL),
('移动端UI设计', '设计移动端应用的UI界面，包含所有核心页面', '2025-11-25 09:00:00', '2025-11-20 18:00:00', 1, 2, 15, 7, 1, 7),
('移动端功能开发', '开发移动端核心功能模块', '2025-11-21 09:00:00', '2025-12-26 18:00:00', 0, 2, 16, 7, 1, 8),
('移动端测试', '进行移动端功能测试和优化', '2025-12-11 09:00:00', '2025-12-25 18:00:00', 0, 1, 15, 7, 1, 9);

-- 7.1 额外任务测试数据：覆盖部门经理(3)、团队长(7)、员工(15)
INSERT INTO task (title, content, start_time, end_time, task_status, task_priority, assignee_id, sender_id, task_type, milestone_id) VALUES
('绩效方案初稿撰写', '撰写新绩效方案初稿并征求各部门意见', '2025-11-10 09:00:00', '2025-11-25 18:00:00', 1, 2, 15, 3, 1, 10),
('绩效方案试点执行', '在人力资源部试点执行新的绩效方案', '2025-11-19 09:00:00', '2025-11-30 18:00:00', 0, 2, 19, 3, 1, 11),
('品牌调研与竞品分析', '市场部员工完成品牌调研与竞品分析报告', '2025-11-05 09:00:00', '2025-11-25 18:00:00', 1, 2, 12, 2, 1, 12),
('品牌宣传文案审核', '团队长审核品牌升级相关宣传文案', '2025-11-16 09:00:00', '2025-11-22 18:00:00', 0, 1, 17, 7, 1, 13);

-- ========================================
-- 8. 日志表测试数据
-- （包含原有日志，并为 employee_id=15 在 2025-11-17 增加两条额外日志）
-- ========================================
...
-- 下面两条是新增的，同一天的额外日志，满足“一天三条且有关联任务”的要求
(15, 11, '2025-11-17 16:00:00', '完善了移动端任务详情页UI，增加任务进度条与负责人信息展示', 1, '北京'),
(15, 11, '2025-11-17 20:30:00', '根据评审意见调整了移动端配色和按钮交互效果', 2, '北京'),
...
-- 8.1 额外日志测试数据：强化员工15在 11/17-23 这一周的行为轨迹
INSERT INTO log (employee_id, task_id, created_time, content, emoji, employee_location) VALUES
(15, 14, '2025-11-18 09:15:00', '根据CEO反馈调整绩效方案中的考核维度', 2, '北京'),
(15, 14, '2025-11-18 15:40:00', '完成绩效方案初稿并发给技术部经理审核', 1, '北京'),
(15, 14, '2025-11-18 20:10:00', '整理各部门意见，准备第二版绩效方案', 1, '北京'),
(15, 1, '2025-11-20 10:00:00', '对数据库索引进行优化，提升查询性能', 1, '北京'),
(15, 3, '2025-11-22 16:30:00', '修复前端页面在移动端适配的问题', 2, '北京');
...
(7, '完成技术团队季度考核', '2025-11-25 18:00:00', 1, 1, 5),
(8, '完成市场部季度业绩目标', '2025-11-30 18:00:00', 1, 2, 6),
(9, '完成员工满意度调查', '2025-11-30 18:00:00', 2, 1, 7),
(10, '完成预算执行情况分析', '2025-11-25 18:00:00', 0, 1, 8),
(15, '完成移动端UI设计，确保用户体验优秀', '2025-11-25 18:00:00', 1, 2, 9),
...
-- 11.1 额外通知测试数据：体现 CEO/部门经理/团队长 与员工15之间的沟通
INSERT INTO notice (sender_id, notice_type, content, created_time, related_id) VALUES
(2, 2, '【CEO通知】请员工15参与人力资源优化项目绩效方案讨论', '2025-11-10 09:30:00', 5),
(3, 2, '【技术部经理通知】请员工15在本周内完成绩效方案初稿', '2025-11-11 10:00:00', 14),
(7, 2, '【技术团队长通知】请员工15同步更新移动端相关任务进度', '2025-11-18 09:00:00', 14);
...
-- 说明：本脚本在结构和基础数据上与原 V2__insert_test_data.sql 保持一致，
-- 仅在日志表中为 employee_id=15 增加了两条 2025-11-17 的额外日志，
-- 用于测试“同一天至少三条且关联任务”的场景。
